---
title: "Running EpiSewer with docker"
output: github_document
---

This vignette describes how to use EpiSewer in a docker container to avoid
installation of CmdStan on your system. The image is available as a package from
...
Pull the docker image from the github container registry (make sure that your
