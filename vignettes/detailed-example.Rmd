...
We here estimate it using smoothing B-splines on the first derivative of R
(`R_estimate_smooth_derivative()`), but there are other smoothing approaches
...
`EpiSewer` will fit a stochastic infection model. This makes sense in most
cases.
