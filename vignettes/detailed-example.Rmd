...
The `damping` component allows to dampen the forecast of Rt so that trends in transmission will level off after some time. This prevents unrealistic extrapolation of transmission dynamics. The default is `0.95`, meaning that the trend is reduced by 5% each day until the Rt forecast is essentially constant.
