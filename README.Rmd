...
`r emo::ji("exclamation_mark")` Note: If you cannot install CmdStan on your system, you can alternatively run the EpiSewer model in a docker container. See the [docker vignette](https://adrian-lison.github.io/EpiSewer/articles/docker-backend.html) for instructions.
