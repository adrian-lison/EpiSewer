...
The development version of `EpiSewer` can be installed from GitHub as shown
below. Please note that the package is still in early development and may be
...
- `r emo::ji("wrench")` **Install CmdStan locally** (recommended): See the [cmdstan installation vignette](https://adrian-lison.github.io/EpiSewer/articles/cmdstan-installation.html) for step-by-step instructions.
