...
estimate the effective reproduction number R_(t) and other transmission
indicators from pathogen concentrations measured in wastewater. This
enables tracking of transmission dynamics both retrospectively and in
real time. `EpiSewer` is tailored to the specifics of wastewater
concentration measurements, offers comprehensive uncertainty
quantification via MCMC sampling in `stan`, and provides easily
configurable modeling components. See our
[paper](https://doi.org/10.1038/s41467-026-75380-3) for a detailed
assessment of the model’s performance.

![](reference/figures/forecasting_example_IAV.gif)
